...
- Timer com ciclos: foco, pausa curta e pausa longa.

- Contagem regressiva estilizada.

- Botão de iniciar e reiniciar ciclo.

## 📍 Buscador de Endereço via CEP

- Input para digitar um CEP.

- Integração com API para consulta (ViaCEP).
